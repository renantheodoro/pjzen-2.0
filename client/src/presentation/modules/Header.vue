    ...
    <div class="container">
      <div class="content__row content__row--align-center">
        <div class="content__column column-desktop--10 flex-v-center">
          ...
          <nav>
            <router-link :to="{ name: 'price-page' }"
        ...
        <div class="content__column column-desktop--2">
          <a
            href="https://www.pjzen.com/acesso"
            target="_blank"
    ...
    <nav class="header--mobile__content" :class="{ open: isMenuOpened }">
      <div class="container flex-center flex-column">
        ...
        <div class="social-buttons">
          <a
            href="https://www.instagram.com/vcpjzen/"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/company/pjzen/"
            target="_blank"
            class="button button--social"
          >
            <svg
